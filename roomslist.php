...
$empty="yes";
//AND available='$empty'
$query=mysqli_query($conn,"select id,name,locality,rent,type_of_house from owners where city='$tok' AND sex='$sex'");
$products=array();
}
...
if(!$products)
{
	echo '<font size="40"color="red"><b>'."Sorry no rooms are available".'</b></font><hr color="white">';
	echo '<font size="5%"color="3b5998"><b>"Please Keep Visiting"</b></font><br>
	<br>
	<br>
	<br>
	<br>';
...
function do_con()
{
  ...
  <div class="mdl-card__media">
    ...
    <div class="mdl-card__title">
      <h2 class="mdl-card__title-text">'.$product->locality.'</h2>
    </div>
    <div class="mdl-card__supporting-text">
      This is a  <b>'.$product->type_of_house.' </b> .The monthly charge is <b>'.$product->rent.'</b>
    </div>
    <div class="mdl-card__actions mdl-card--border">
      <a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" data-upgraded=",MaterialButton,MaterialRipple" href="roomsinfo.php?id='.$product->id.'" >Get More Info</a>
    </div>
