  ...
  <article class="articleShort articleMain">
    <div class="card">
      ...
      <div class="card-content">
        <h3><?php echo $rows['name'];?> , <?php echo $rows['locality'];?> , <?php echo $rows['city'];?></h3>
        <p>Prices  may or may not be negotiable .          </p>
...
<div class="a11">
<a href="#" class="a1">Get full address from map.</a>
<a href="#" class="a1">We hope that you will find best house.</a>
<a href="#" class="a1">Giving our reference will lay down some prices for you .So dont forget to mention our reference.</a>
<a href="#" class="a1">For more information regarding this flat contact us.</a>
<a href="#" class="a1">Dont forget to signUp for better experience and to get updates of new rooms near you.</a>
<a href="#" class="a1">Thats all. thanks for visiting.</a>
</div>
  </div>
    <script>
      function initMap() {
