...
$sql="select f_name,email,password,l_name from login where email='$email' and f_name='$fname'";
...
$query=mysqli_query($conn,"select id,h_name,locality,r_1s,r_2s,r_3s,email from hostel where email='$email'");
$products=array();
...
function do_con1()
{
	...
	{
		$table.='<p align="center"><div class="business-card centered">
  <div class="title">
    '.$product->locality.'
  </div>
  <div class="content span2">
    Rs.'.$product->r_1s.'&nbsp;'.$product->r_2s.'&nbsp;'.$product->r_3s.'<br />
    <span class="finer-print">'.$product->h_name.'<br />
      Independent<br />
    </span>
  </div>
  <div class="content span2">
    <img src="http://www.gravatar.com/avatar/c2b06fbfe35d23dd71368c02157006ee.png" alt="avatar" class="avatar" />
  </div>
  <div class="footer">
    click here to get <a class="btn-draw" href="edithostel.php?id='.$product->id.'">edit info</a>
  </div>
</div>';	
...
$query=mysqli_query($conn,"select id,name,locality,rent,type_of_house,email from owners where email='$email'");
$products=array();
...
function do_con()
{
  ...
  <div class="content span2">
    Rs.'.$product->rent.'<br />
    <span class="finer-print">'.$product->type_of_house.'<br />
      Independent<br />
    </span>
  </div>
  <div class="content span2">
  ...
  <div class="footer">
    click here to  <a class="btn-draw" href="editroom.php?id='.$product->id.'">Edit info</a>
  </div>
</div>';	
...
?>  </ul>
  ...
  <div id="w">
    <div id="content" class="clearfix">
      <div id="userphoto"><img src="img_avatar2.png" alt="default avatar" height="150px" width="150px"></div>
      <h1> User Profile </h1>

      <nav id="profiletabs">
        <ul class="clearfix">
          <li><a href="#settings"><?php echo$_SESSION['fname'];?></a></li>
        </ul>
      </nav>
      ...
      <section id="bio">
        ...
        <p class="setting"><span>Name </span> <?php echo$_SESSION['fname'];?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo$lname;?> </p>
